...
final class CreateBookingFormState {
    ...
    private boolean hasPreselectedRoom;
    private boolean partialRoom;
    private String availableFromDate;
    private String availableFromTime;
    private boolean hasPreselectedDateRange;
    ...
    CreateBookingFormState copy() {
        CreateBookingFormState copy = new CreateBookingFormState();
        copy.roomId = roomId;
        copy.preselectedRoomName = preselectedRoomName;
        copy.hasPreselectedRoom = hasPreselectedRoom;
        copy.partialRoom = partialRoom;
        copy.availableFromDate = availableFromDate;
        copy.availableFromTime = availableFromTime;
        copy.hasPreselectedDateRange = hasPreselectedDateRange;
    ...
    String getPreselectedRoomName() { return preselectedRoomName; }
    void setPreselectedRoomName(String preselectedRoomName) { this.preselectedRoomName = clean(preselectedRoomName); }
    boolean hasPreselectedRoom() { return hasPreselectedRoom; }
    void setHasPreselectedRoom(boolean hasPreselectedRoom) { this.hasPreselectedRoom = hasPreselectedRoom; }
    boolean isPartialRoom() { return partialRoom; }
    void setPartialRoom(boolean partialRoom) { this.partialRoom = partialRoom; }
    String getAvailableFromDate() { return availableFromDate; }
    void setAvailableFromDate(String availableFromDate) { this.availableFromDate = clean(availableFromDate); }
    String getAvailableFromTime() { return availableFromTime; }
    void setAvailableFromTime(String availableFromTime) { this.availableFromTime = clean(availableFromTime); }
    boolean hasPreselectedDateRange() { return hasPreselectedDateRange; }
    void setHasPreselectedDateRange(boolean hasPreselectedDateRange) { this.hasPreselectedDateRange = hasPreselectedDateRange; }
